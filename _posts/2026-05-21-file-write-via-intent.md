---
title: Android - File Write via an Exported Activity
author: nirajkharel
...
<aside class="lab">
  ...
  <ul>
    <li><code>android/app/src/main/java/com/vulnlab/app/activities/FileWriteActivity.java</code></li>
  </ul>
</aside>
...
```bash
adb shell am start -n com.vulnlab.app/.activities.FileWriteActivity \
  --es filename "PROBE_canary.txt" --es content "probe"
```
<img alt="" class="bf jp jq dj" loading="lazy" role="presentation" src="https://raw.githubusercontent.com/nirajkharel/nirajkharel.github.io/master/assets/img/images/file-write-1.png">
...
<img alt="" class="bf jp jq dj" loading="lazy" role="presentation" src="https://raw.githubusercontent.com/nirajkharel/nirajkharel.github.io/master/assets/img/images/file-write-2.png">
